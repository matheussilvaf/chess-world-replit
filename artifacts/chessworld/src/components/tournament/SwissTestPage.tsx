      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {!tournament ? (
          ...
          <div className="space-y-6">
            ...
            {diagnostics && (
              <DiagnosticsSection diagnostics={diagnostics} engineStatus={health ? { available: health.pairingEngine, version: health.engineVersion, error: health.engineError } : null} />
            )}
