...
import { Settings, Gauge, ZoomIn, ArrowLeft, Crosshair, Bug, Waypoints, Monitor, Smartphone, MessageSquare, Wand2, Swords, Hammer, Boxes, Sprout, Factory, Sparkles, Crown, Star, Database, Target } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-lime-500/10 flex items-center justify-center">
              <Target className="w-4 h-4 text-lime-400" />
            </div>
            <div>
              <p className="text-sm font-medium text-white">Hunting Controller</p>
              <p className="text-xs text-slate-400">Animais, contratos e rigs de caça</p>
            </div>
          </a>
          <a
            href="/admin/rigs"
          ...
          <a
            href="/admin/stations"
            className="flex items-center gap-3 rounded-xl border border-slate-800 bg-slate-900 hover:border-orange-500/50 hover:bg-slate-800/80 transition-colors p-4"
          >
            <div className="w-9 h-9 rounded-lg bg-orange-500/10 flex items-center justify-center">
              <Factory className="w-4 h-4 text-orange-400" />
            </div>
            <div>
              <p className="text-sm font-medium text-white">Stations Controller</p>
              <p className="text-xs text-slate-400">Estações de criação, abas e layout</p>
            </div>
          </a>
          <a
            href="/admin/mundo-coleta"
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-white">Mundo de Coleta</p>
              <p className="text-xs text-slate-400">Minérios e caixas de acerto dos recursos</p>
            </div>
          </a>
          <a
