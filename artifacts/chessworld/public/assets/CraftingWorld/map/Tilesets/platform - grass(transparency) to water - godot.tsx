...
<tileset version="1.10" tiledversion="1.11.2" name="platform - grass(transp) to water-godot" tilewidth="32" tileheight="32" tilecount="648" columns="12">
 <image source="../../Tilesets/Platform - grass to water/platform -grass(transparency) to water-spritesheet - Godot.png" width="384" height="1728"/>
 <tile id="24">
  <animation>
 ...
 <wangsets>
  <wangset name="grass(transp) to water-godot(river)" type="corner" tile="228">
   <wangcolor name="" color="#ff0000" tile="228" probability="1"/>
   ...
   <wangtile tileid="108" wangid="0,0,0,0,0,1,0,0"/>
   <wangtile tileid="120" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="132" wangid="0,0,0,1,0,0,0,0"/>
   <wangtile tileid="144" wangid="0,1,0,1,0,1,0,0"/>
   <wangtile tileid="156" wangid="0,0,0,1,0,0,0,0"/>
   <wangtile tileid="168" wangid="0,1,0,1,0,0,0,0"/>
   ...
   <wangtile tileid="240" wangid="0,0,0,1,0,0,0,1"/>
   <wangtile tileid="252" wangid="0,1,0,0,0,1,0,0"/>
   ...
   <wangtile tileid="324" wangid="0,0,0,0,0,1,0,1"/>
   <wangtile tileid="336" wangid="0,0,0,0,0,1,0,1"/>
   <wangtile tileid="348" wangid="0,0,0,0,0,1,0,1"/>
   <wangtile tileid="372" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="384" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="396" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="408" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="420" wangid="0,1,0,0,0,0,0,1"/>
   <wangtile tileid="432" wangid="0,1,0,0,0,0,0,1"/>
   <wangtile tileid="444" wangid="0,1,0,0,0,0,0,1"/>
   <wangtile tileid="456" wangid="0,1,0,0,0,0,0,1"/>
  </wangset>
 </wangsets>
</tileset>
