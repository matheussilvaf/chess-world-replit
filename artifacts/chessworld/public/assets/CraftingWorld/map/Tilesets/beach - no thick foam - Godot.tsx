...
<tileset version="1.10" tiledversion="1.11.2" name="beach - no thick foam - godot" tilewidth="32" tileheight="32" tilecount="418" columns="19">
 <image source="../../Tilesets/Beach/beach - standard - no thick foam - spritesheet - Godot.png" width="608" height="704"/>
 <tile id="19">
  <animation>
 ...
 <wangsets>
  <wangset name="beach - no thick foam(godot)" type="corner" tile="171">
