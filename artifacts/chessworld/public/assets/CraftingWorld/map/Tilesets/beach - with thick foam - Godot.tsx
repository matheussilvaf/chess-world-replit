...
<tileset version="1.10" tiledversion="1.11.2" name="beach - with thick foam - godot" tilewidth="32" tileheight="32" tilecount="418" columns="19">
 <image source="../../Tilesets/Beach/beach - standard - with thick foam - spritesheet - Godot.png" width="608" height="704"/>
 <tile id="19">
  <animation>
 ...
 <wangsets>
  <wangset name="beach - with thick foam(godot)" type="corner" tile="171">
   <wangcolor name="" color="#ff0000" tile="171" probability="1"/>
   ...
   <wangtile tileid="114" wangid="0,0,0,1,0,1,0,1"/>
   ...
   <wangtile tileid="228" wangid="0,0,0,1,0,0,0,0"/>
   <wangtile tileid="247" wangid="0,1,0,1,0,0,0,0"/>
   <wangtile tileid="285" wangid="0,1,0,0,0,0,0,0"/>
   <wangtile tileid="304" wangid="0,1,0,1,0,0,0,1"/>
   <wangtile tileid="323" wangid="0,1,0,0,0,0,0,0"/>
   <wangtile tileid="342" wangid="0,1,0,0,0,0,0,1"/>
   <wangtile tileid="361" wangid="0,1,0,0,0,1,0,0"/>
   <wangtile tileid="380" wangid="0,0,0,1,0,0,0,1"/>
  </wangset>
 </wangsets>
</tileset>
