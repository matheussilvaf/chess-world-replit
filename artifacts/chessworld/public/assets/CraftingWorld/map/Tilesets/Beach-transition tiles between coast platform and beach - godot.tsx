...
<tileset version="1.10" tiledversion="1.11.2" name="Beach-transition tiles between coast platform and beach - godot" tilewidth="32" tileheight="32" tilecount="260" columns="20">
 <image source="../../Tilesets/Beach/Beach-transition tiles between coast platform and beach-spritesheet - Godot.png" width="640" height="416"/>
 <tile id="23">
  <animation>
